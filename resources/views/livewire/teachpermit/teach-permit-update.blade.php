<div>
    ...
    <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl dark:text-white">Update Permit to Teach</h2>
                                        ...
                                        <div class="w-full grid grid-cols-1 ">
                                            <label for="inside_outside_university"
                                                ...
                                                <div class="grid grid-cols-4 w-full pl-4 items-start">
                                                    ...
                                                    <div>
                                                        <input type="radio" class="textindigo borderindigo" id="inside_outside_university" name="inside_outside_university" wire:model="inside_outside_university" value="Outside the iversity">
                                        ...
                                        <div class="grid grid-cols-1 min-[1000px]:grid-cols-2 col-span-5 ">
                                            ...
                                            <div class="grid grid-cols-1 min-[1404px]:grid-cols-3 p-6 gap-4  bg-white border border-gray-200  shadow  dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <div class="mt-5">
                                                    ...
                                                    <input type="number" rows="4" id="subjectLoad_{{$index}}_number_of_units" name="subjectLoad_{{$index}}_number_of_units" wire:model.live="subjectLoad.{{$index}}.number_of_units" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></input>
