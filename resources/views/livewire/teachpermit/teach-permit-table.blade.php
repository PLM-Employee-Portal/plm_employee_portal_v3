<div class="main-content">
        <div class="p-4 rounded-lg dark:border-gray-700 ">
            ...
            <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl dark:text-white">Teach Permit</h2>
  
            
            <div class="flex justify-end">
                <button type="button" onclick="location.href='{{ route('TeachPermitForm') }}'" class="text-white mb-8 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create Teach Permit</button>
            ...
            <div class="overflow-x-auto shadow-md rounded-t-lg bg-white pb-4">
                <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4 p-4">
                    <div>
                        ...
                        {{-- Status Filter --}}
                        <button id="dropdownRadioButton" data-dropdown-toggle="statusDropDown" class=" z-50 inline-flex items-center text-gray-500 bg-white border h-10  border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
                            <svg class="w-3 h-3 text-gray-500 dark:text-gray-400 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm3.982 13.982a1 1 0 0 1-1.414 0l-3.274-3.274A1.012 1.012 0 0 1 9 10V6a1 1 0 0 1 2 0v3.586l2.982 2.982a1 1 0 0 1 0 1.414Z"/>
                                </svg>
                            {{$statusFilterName}}
                    ...
                    <div>
                        <div>
                            ...
                            @else
                                ...
                                @php
                                    $ctr = 0;
                                    $pageIndex = ($TeachPermitData->currentpage() - 1) * $TeachPermitData->perpage() + $ctr;

                                @endphp
                                @foreach ($TeachPermitData as $index => $teachpermit)
                                @php
                                    $ctr = $ctr + 1;
                                ...
                                @endphp
                                    ...
                                    @elseif($teachpermit->status == "Approved")
                                        <th scope="row" class="px-6 py-4 text-center font-medium text-gray-900 whitespace-nowrap dark:text-white capitalize">
                                    ...
                                    @endif
                                        <td class="px-6 py-4 text-center whitespace-nowrap">
                                            {{$teachpermit->application_date}}
                                        </td>
                                        <td class="px-6 py-4 text-center whitespace-nowrap">
                                            {{$teachpermit->name_of_school_description}}
                                        </td>
                                        <td class="px-6 py-4 text-center whitespace-nowrap">
                                            {{$teachpermit->start_period_cover}}
                                        </td>
                                        <td class="px-6 py-4 text-center">
                                            {{$teachpermit->end_period_cover}}
                                        </td>
                                        {{-- <a onclick="location.href='{{ route('ipcredit', ['index' => $teachpermit->id]) }}'"  class="cursor-pointer font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a> --}}
                                            {{-- <a href="{{route('ipcredit', $teachpermit)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a> --}}
                                            {{-- <a wire:click="removeIpcr({{$teachpermit->id}})" class="cursor-pointer font-medium text-red-600 dark:text-red-500 hover:underline ms-3">Remove</a> --}}
                                            ...
                                            <td class="items-center text-center py-4">
                                                ...
                                                <div class="hidden  top-0 right-0 mt-2 z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                    ...
                                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                        @if (is_null($teachpermit->permit_to_teach))
                                                            <li>
                                                                <a onclick="location.href='{{ route('TeachPermitEdit', ['index' => $teachpermit->reference_num]) }}'"  class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                                            </li>
                                                        @endif
                                                        <li>
                                                    ...
                                                    <div class="py-2">
                                                        <a wire:click="removeTeachPermit('{{$teachpermit->reference_num}}')" wire:confirm="Are you sure you want to delete this post?" class="block px-4 py-2 text-black hover:bg-red-600 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
