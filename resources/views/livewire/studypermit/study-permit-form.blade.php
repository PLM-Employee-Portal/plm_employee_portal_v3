<div>
    <nav class="flex mb-4" aria-label="Breadcrumb">
        ...
        <li>
            ...
            <a href="{{route('StudyPermitTable')}}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Study Permit</a>
            </div>
        </li>
    ...
    <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl dark:text-white">Create a new Study Permit</h2>
                        ...
                        <div class="grid gap-4 sm:grid-cols-3 sm:gap-6">
                                ...
                                <div class="grid grid-cols-1 w-full col-span-3 gap-4 min-[1000px]:grid-cols-2 p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <div>
                                            ...
                                            class="block  pt-4 text-sm font-medium mb-4  text-gray-900 dark:text-white">Indicate the degree program and school where employee intends to enroll. (Please indicate address and contact numbers if outside the University.) <span class="text-red-600">*</span></label>
                                            <textarea type="text" rows="4" id="degree_prog_and_school" name="degree_prog_and_school" wire:model="degree_prog_and_school"
                                            placeholder="Type here..."   
                                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            </textarea>
                                        </div>
                                        @error('degree_prog_and_school')   
                                            <div class="transition transform alert alert-danger text-sm "
                                            x-init="$el.closest('form').scrollIntoView()">
                                            <span class="text-red-500 text-xs xl:whitespace-nowrap">{{ $message }}</span>
                                            </div> 
                            ...
                            <div class="grid grid-cols-1 col-span-3 p-6 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                        ...
                                        <div class="grid grid-cols-1 min-[1000px]:grid-cols-2 col-span-5 ">
                                            ...
                                            <div class="grid grid-cols-1 min-[1404px]:grid-cols-3 p-6 gap-4  bg-white border border-gray-200  shadow  dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <div class="mt-5">
                                                    ...
                                                    <input type="text" rows="4" id="subjectLoad_{{$index}}_number_of_units" name="subjectLoad_{{$index}}_number_of_units" wire:model.live="subjectLoad.{{$index}}.number_of_units" placeholder="Number of Units" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></input>
                                ...
                                <div class="grid grid-cols-1 min-[740px]:grid-cols-2 col-span-3 p-6 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                        <div class="w-full">
                                            ...
                                            <input type="number" name="available_units" id="available_units" wire:model="study_available_units"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            ...
                            <div class="grid grid-cols-1 col-span-3 p-6 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                ...
                                <div class="grid grid-cols-1 min-[1000px]:grid-cols-2 gap-4">
                                        ...
                                        <div class=" ">
                                            <div class="w-full">
                                                <label for="total_teaching_load"
                                                    class="block mb-2  text-sm font-medium text-gray-900 dark:text-white">Total Teaching Load (for faculty only) <span class="text-red-600">*</span></label>
                                                <input type="number" name="total_teaching_load" id="total_teaching_load"  wire:model.blur="total_teaching_load"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                     required="" >
                                                @error('total_teaching_load')
                                                    <div class="transition transform alert alert-danger text-sm"
                                                    x-data x-init="document.getElementById('total_teaching_load').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('total_teaching_load').focus();" >
                                                        <span class=    "text-red-500 text-xs" > {{$message}}</span>
                                                    </div> 
                                                @enderror
                                            </div>
                                    ...
                                    <div id="applicant_signature_container" class="grid grid-cols-1  p-4 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    ...
                                    <div class="grid grid-cols-1 items-start min-[800px]:grid-cols-2 gap-4">
                                        ...
                                        <label for="rated_ipcr"
                                            class="block text-sm font-medium text-gray-900 dark:text-white">3. Rated IPCR (last 2 rating periods)<span class="text-red-600">*</span></label>
                                        <div class="grid grid-cols-1   w-full">
                                            @if ($rated_ipcr)
                                    ...
                                    <div class="grid grid-cols-1 items-start min-[800px]:grid-cols-2 gap-4">
                                        ...
                                        <label for="teaching_assignment"
                                            class="block text-sm font-medium text-gray-900 dark:text-white">8. Teaching Assignment (For Faculty Members)</label>
                                        <div class="grid grid-cols-1   w-full">
                        ...
                        {{-- <div class="grid grid-cols-1 col-span-3 p-6 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div class="w-full mt-4">
                                    ...
                                    <input type="date" name="recommended_date" id="recommended_date" wire:model="date_recommended_by" 
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        required="">
                                ...
                                <div class="col-span-2 grid grid-cols-1 p-4 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                    ...
                                    class="block text-sm font-medium text-gray-900 dark:text-white">Recommended By<span class="text-red-600">*</span></label>
                                    <div class="grid grid-cols-1 items-center justify-center w-full">
                                        ...
                                        @else
                                            <label for="signature_recommended_by" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                    ...
                                                    <p class="mb-2 text-xs text-center text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload</span></p>
                                                    <p class="text-xs text-center text-gray-500 dark:text-gray-400">PNG, JPG, or PDF files (Max: 3 files | 5MB each)</p>
                                                </div>
                                                <input id="signature_recommended_by" type="file" class="hidden" wire:model.blur="signature_recommended_by">
                                            </label>
                                        @endif
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                ...
                                <div class="col-span-2 grid grid-cols-1 p-4 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                    ...
                                    class="block text-sm font-medium text-gray-900 dark:text-white">Endorsed By<span class="text-red-600">*</span></label>
                                    <div class="grid grid-cols-1 items-center justify-center w-full">
