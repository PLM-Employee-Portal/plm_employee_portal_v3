<div class="main-content">
    <div class="p-4 rounded-lg dark:border-gray-700 ">
        ...
        <div class="flex justify-end">
            <button type="button" onclick="location.href='{{ route('ChangeScheduleForm') }}'" class="text-white mb-8 bgindigo focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create Schedule Change Request</button>
