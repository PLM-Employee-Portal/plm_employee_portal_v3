        ...
        <div class="p-4 rounded-lg dark:border-gray-700 ">
            <nav class="flex mb-4" aria-label="Breadcrumb">
                ...
                <li>
                    ...
                    <a href="{{route('ApproveChangeInformationTable')}}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Change Information</a>
                    </div>
                </li>
            ...
            <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl dark:text-white">Approve Change Information Requests</h2>
            <br><br>
            <div class="overflow-x-auto shadow-md rounded-t-lg bg-white pb-4">
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 pb-4">
                    ...
                    <div>
                        <div>
                            @if (count($ChangeInformationData) == 0)
                            <tbody class="pb-4">
                            ...
                            @else
                                @php
                                    $ctr = 0;
                                    $pageIndex = ($ChangeInformationData->currentpage() - 1) * $ChangeInformationData->perpage() + $ctr;

                                @endphp
                                @foreach ($ChangeInformationData as $index => $changeinformation)
                                @php
                                    $ctr = $ctr + 1;
                                ...
                                <tbody>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4 text-center whitespace-nowrap">
                                            {{$changeinformation->employee_id}}
                                        </td>
                                        @if($changeinformation->status == "Pending")
                                    ...
                                    @elseif($changeinformation->status == "Accepted")
                                        <th scope="row" class="px-6 py-4 text-center font-medium text-gray-900 whitespace-nowrap dark:text-white capitalize">
                                    ...
                                    @endif
                                        ...
                                        <td class="px-6 py-4 text-center whitespace-nowrap">
                                            {{$changeinformation->created_at}}
                                        </td>
                                    
                                        {{-- <a onclick="location.href='{{ route('ipcredit', ['index' => $changeinformation->id]) }}'"  class="cursor-pointer font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a> --}}
                                            {{-- <a href="{{route('ipcredit', $changeinformation)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a> --}}
                                            {{-- <a wire:click="removeIpcr({{$changeinformation->id}})" class="cursor-pointer font-medium text-red-600 dark:text-red-500 hover:underline ms-3">Remove</a> --}}
                                            ...
                                            <td class="items-center text-center py-4">
                                                ...
                                                <div class="hidden  top-0 right-0 mt-2 z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                    ...
                                                    <div class="py-2">
                                                        <a wire:click="removeTeachPermit({{$changeinformation->id}})" wire:confirm="Are you sure you want to delete this post?" class="block px-4 py-2 text-black hover:bg-red-600 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            {{-- <td class="items-center px-6 py-4">
                                                ...
                                                <div class="hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                    ...
                                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                        <li>
                                                            <a onclick="location.href='{{ route('TeachPermitEdit', ['index' => $changeinformation->id]) }}'"  class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                                        </li>
                                                        <li>
                                                            <a onclick="location.href='{{ route('TeachPermitPdf', ['index' => $changeinformation->id]) }}'" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">PDF</a>
                                                        </li>
                                                    </ul>
                                                    <div class="py-2">
                                                        <a wire:click="removeStudyPermit({{$changeinformation->id}})" wire:confirm="Are you sure you want to delete this post?" class="block px-4 py-2 text-black hover:bg-red-600 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">Delete</a>
                                                    </div>
                                                </div>
                                            </td> --}}
                                    </tr>
