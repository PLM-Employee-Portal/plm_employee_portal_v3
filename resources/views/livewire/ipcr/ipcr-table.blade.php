<div class="main-content">
        <div class="p-4 rounded-lg dark:border-gray-700">
            ...
            <div class="flex justify-end">
                <button type="button" onclick="location.href='{{ route('IpcrForm', ['type' => 'target']) }}'" class="text-white mb-8 bg-blue-700 hover:bg-white hover:text-blue-800 border hover:border-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create Target IPCR</button>
                                        ...
                                        <td class="items-center text-center py-4">
                                            ...
                                            <div class="hidden top-0 right-0 mt-2 z-50 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                ...
                                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                                    <li>
                                                        <a onclick="location.href='{{ route('IpcrEdit', ['index' => $ipcr->reference_num]) }}'"  class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                                    </li>
                                                    <li>
                                                        <a onclick="location.href='{{ route('IpcrPdf', ['index' => $ipcr->reference_num]) }}'" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">PDF</a>
                                                    </li>
                                                </ul>
                                                <div class="py-2">
                                                    <a wire:click="removeIpcr({{$ipcr->reference_num}})" wire:confirm="Are you sure you want to delete this post?" class="block px-4 py-2 text-black hover:bg-red-600 hover:text-white dark:hover:bg-gray-600 dark:hover:text-white">Delete</a>
                                                </div>
                                            </div>
                                        </td>
