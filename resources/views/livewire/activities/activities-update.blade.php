<div>
    ...
    <div class="flex justify-end">
        <button type="button" wire:click="removeActivity" class="text-white mb-8 bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Delete Activity</button>
    ...
    <section class="bg-white  dark:bg-gray-900 pb-24 px-8  rounded-lg">
        ...
        <div class=" px-1 mx-auto pt-8">
            ...
            <div class="grid grid-cols-1 gap-4  p-6 mt-5 mb-4    bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
                {{-- <div>
