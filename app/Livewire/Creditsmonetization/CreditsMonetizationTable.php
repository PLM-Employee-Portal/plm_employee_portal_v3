...
class CreditsMonetizationTable extends Component
{
    ...
    public function render()
    {
        ...
        $query = Monetization::where('employee_id', $loggedInUser->employee_id);
    ...
    public function download($reference_num){
        $teachpermitData = Monetization::where('reference_num', $reference_num)->first();
